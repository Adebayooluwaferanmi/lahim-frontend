...
import { Button, Container, Row, Column, Panel, Spinner, Alert } from '@hospitalrun/components'
          ...
          <Column md={4}>
            <SelectWithLableFormGroup
              ...
              options={[
                ...
                { value: 'outstanding-balances', label: t('reports.types.outstandingBalances', 'Outstanding Balances') },
